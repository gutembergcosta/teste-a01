    ...
    <div class="panel-body" id="hg-{{ $tipo }}">
        ...
        <div class="row">
            <div class="col-md-12 _item" style="{{ ($img) ? '' : 'display: none' }}">
                <div>
                    <a class="link-img" target="_blank" href="@if($img){{ url('/public/uploads/original-'.$img['arquivo']) }}@endif">
                        <img class="total" src="@if($img){{ url('/assets/img/arquivo.jpg') }}@endif">
                    </a>
                </div>
                <div>
            ...
            $(document).ready(function() {
                $("#img-destaque-{{ $tipo }}").uploadFile({
                    ...
                    onSuccess:function(files,data,xhr,pd)
                    {
                        ...
                        $(box).find('img').attr('src', `{{ url('/assets/img/arquivo.jpg') }}`);
