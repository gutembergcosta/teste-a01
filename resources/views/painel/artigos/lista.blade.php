            ...
            <div class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row area-btn-novo">
                        <div class="col-md-12">
                            <a href="{{ route('admin.artigo-form', ['add']) }}" class="btn btn-success btn-xs"> 
                                    ...
                                    <div class="">
                                        <table class="table table-bordered tabela">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a class="tb_link" href="{{ route('admin.artigo-form', ['edit', $item['id']]) }}">{{ $item['nome'] }}</a> </td>
                                                    <td>{{  $item->arquivos->where('tipo', 'destaque')->first()['arquivo'] }}</a> </td>
                                                    <td>{{  $item->arquivos->where('tipo', 'galeria')->count() }}</a> </td>
                                                    <td>
